"""Error handling utilities for the KdzeDev workflow system."""
...
async def handle_mac_exception(request: Request, exc: MACException) -> JSONResponse:
    """Handle KdzeDev exceptions and return standardized error response."""
    logger = get_server_logger()
    
    # Log the error
    logger.log_exception(
        exc,
        f"KdzeDev exception occurred: {exc.error_code} - {exc.message}",
